...
export const SPELLS_LEVEL_3: SpellDefinition[] = [
  {
    ...
    range: '10 pies',
    components: 'V, S, M (un hueso)',
    duration: 'Instantáneo',
    concentration: false,
    classes: ['cleric', 'wizard'],
    description: 'Crea un no-muerto (esqueleto o zombi) bajo tu control.'
  },
  {
    id: 'bestow_curse',
    ...
    concentration: true,
    classes: ['cleric', 'wizard'],
    description: 'Maldice a una criatura con diversos efectos negativos.'
  },
  {
    id: 'blink',
    name: 'Parpadeo',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Puedes desaparecer temporalmente a otro plano al final de cada turno.'
  },
  {
    id: 'clairvoyance',
    name: 'Clarividencia',
    ...
    concentration: true,
    classes: ['bard', 'cleric', 'sorcerer', 'wizard'],
    description: 'Creas un sensor invisible para ver u oír a distancia.'
  },
  {
    id: 'counterspell',
    name: 'Contraconjuro',
    ...
    concentration: false,
    classes: ['sorcerer', 'warlock', 'wizard'],
    description: 'Interrumpe un conjuro en lanzamiento.'
  },
  {
    id: 'daylight',
    name: 'Luz del Día',
    ...
    description: 'Crea una esfera de luz brillante.'
  },
  {
    id: 'dispel_magic',
    name: 'Disipar Magia',
    ...
    description: 'Elimina efectos mágicos.'
  },
  {
    id: 'fear',
    name: 'Miedo',
    ...
    school: 'Ilusión',
    castingTime: '1 acción',
    range: 'Cono de 30 pies',
    components: 'V, S, M',
    duration: 'Concentración, hasta 1 minuto',
    concentration: true,
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    description: 'Las criaturas huyen aterradas.'
  },
  {
    id: 'feign_death',
    name: 'Fingir Muerte',
    ...
    description: 'Hace que una criatura parezca muerta.'
  },
  {
    id: 'fireball',
    name: 'Bola de Fuego',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Explosión de fuego de 8d6 en área.'
  },
  {
    id: 'fly',
    name: 'Volar',
    ...
    concentration: true,
    classes: ['sorcerer', 'warlock', 'wizard'],
    description: 'Otorga velocidad de vuelo.'
  },
  {
    id: 'gaseous_form',
    name: 'Forma Gaseosa',
    ...
    concentration: true,
    classes: ['sorcerer', 'warlock', 'wizard'],
    description: 'Transforma a la criatura en niebla.'
  },
  {
    id: 'glyph_of_warding',
    name: 'Glifo Custodio',
    ...
    range: 'Toque',
    components: 'V, S, M',
    duration: 'Hasta disiparse',
    concentration: false,
    classes: ['bard', 'cleric', 'wizard'],
    description: 'Crea una trampa mágica.'
  },
  {
    id: 'haste',
    name: 'Acelerar',
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Buff potente de velocidad y acciones.'
  },
  {
    id: 'hypnotic_pattern',
    ...
    concentration: true,
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    description: 'Incapacita múltiples enemigos.'
  },
  {
    id: 'leomunds_tiny_hut',
    name: 'Cúpula de Leomund',
    level: 3,
    school: 'Evocación',
    castingTime: '1 minuto',
    range: 'Personal',
    ...
    concentration: false,
    classes: ['bard', 'wizard'],
    description: 'Refugio mágico seguro.'
  },
  {
    id: 'lightning_bolt',
    name: 'Relámpago',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Rayo en línea de 8d6.'
  },
  {
    id: 'magic_circle',
    name: 'Círculo Mágico',
    ...
    description: 'Protección contra criaturas.'
  },
  {
    id: 'major_image',
    name: 'Imagen Mayor',
    ...
    concentration: true,
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    description: 'Ilusión compleja.'
  },
  {
    id: 'mass_healing_word',
    name: 'Palabra Sanadora Masiva',
    level: 3,
    school: 'Evocación',
    ...
    concentration: false,
    classes: ['bard', 'cleric'],
    description: 'Cura a múltiples criaturas.'
  },
  {
    id: 'meld_into_stone',
    ...
    concentration: false,
    classes: ['cleric', 'druid'],
    description: 'Te fusionas con piedra.'
  },
  {
    id: 'nondetection',
    name: 'Indetección',
    ...
    description: 'Evita detección mágica.'
  },
  {
    id: 'phantom_steed',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Montura mágica rápida.'
  },
  {
    id: 'plant_growth',
    ...
    concentration: false,
    classes: ['bard', 'druid', 'ranger'],
    description: 'Controla vegetación.'
  },
  {
    ...
    description: 'Resistencia a daño elemental.'
  },
  {
    id: 'remove_curse',
    ...
    concentration: false,
    classes: ['cleric', 'paladin', 'warlock', 'wizard'],
    description: 'Elimina maldiciones.'
  },
  {
    id: 'revivify',
    name: 'Revivir',
    ...
    castingTime: '1 acción',
    range: 'Toque',
    components: 'V, S, M (diamantes)',
    duration: 'Instantáneo',
    concentration: false,
    classes: ['cleric', 'paladin'],
    description: 'Devuelve a la vida a una criatura recién muerta.'
  },
  {
    id: 'sending',
    name: 'Mensaje',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'wizard'],
    description: 'Envía mensaje a cualquier distancia.'
  },
  {
    id: 'sleet_storm',
    ...
    concentration: true,
    classes: ['druid', 'sorcerer', 'wizard'],
    description: 'Área difícil + interrupción de concentración.'
  },
  {
    id: 'slow',
    name: 'Lentitud',
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Reduce velocidad y acciones.'
  },
  {
    id: 'speak_with_dead',
    ...
    concentration: false,
    classes: ['bard', 'cleric'],
    description: 'Interroga a un cadáver.'
  },
  {
    ...
    concentration: false,
    classes: ['bard', 'druid', 'ranger'],
    description: 'Comunicación con plantas.'
  },
  {
    id: 'spirit_guardians',
    ...
    concentration: true,
    classes: ['cleric'],
    description: 'Espíritus que dañan enemigos cercanos.'
  },
  {
    id: 'stinking_cloud',
    name: 'Nube Apestosa',
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Nube que incapacita criaturas.'
  },
  {
    id: 'tongues',
    name: 'Lenguas',
    ...
    description: 'Permite entender y hablar cualquier idioma.'
  },
  {
    id: 'vampiric_touch',
    ...
    concentration: true,
    classes: ['warlock', 'wizard'],
    description: 'Daño necrótico y cura al lanzador.'
  },
  {
    id: 'water_breathing',
    ...
    concentration: false,
    classes: ['druid', 'ranger', 'sorcerer', 'wizard'],
    description: 'Permite respirar bajo el agua.'
  },
  {
    id: 'water_walk',
    ...
    description: 'Permite caminar sobre líquidos.'
  },
  {
    id: 'wind_wall',
    name: 'Muro de Viento',
    ...
    concentration: true,
    classes: ['druid', 'ranger', 'sorcerer', 'wizard'],
    description: 'Crea un muro de viento que bloquea proyectiles.'
  }
];
...
export const SPELLS_LEVEL_4: SpellDefinition[] = [
  {
    ...
    concentration: true,
    classes: ['wizard'],
    description: 'Creas un ojo invisible que exploras remotamente.'
  },
  {
    id: 'banishment',
    name: 'Destierro',
    ...
    description: 'Envía una criatura a otro plano temporalmente.'
  },
  {
    id: 'blight',
    name: 'Marchitar',
    ...
    concentration: false,
    classes: ['druid', 'sorcerer', 'warlock', 'wizard'],
    description: 'Daño necrótico fuerte a un objetivo.'
  },
  {
    id: 'confusion',
    name: 'Confusión',
    ...
    concentration: true,
    classes: ['bard', 'druid', 'sorcerer', 'wizard'],
    description: 'Los enemigos actúan de forma errática.'
  },
  {
    ...
    concentration: true,
    classes: ['druid', 'wizard'],
    description: 'Invoca elementales pequeños.'
  },
  {
    ...
    concentration: true,
    classes: ['druid', 'ranger'],
    description: 'Invoca criaturas feéricas.'
  },
  {
    id: 'control_water',
    name: 'Controlar Agua',
    ...
    description: 'Manipula grandes masas de agua.'
  },
  {
    id: 'death_ward',
    ...
    concentration: false,
    classes: ['cleric', 'paladin'],
    description: 'Evita que una criatura caiga a 0 HP una vez.'
  },
  {
    id: 'dimension_door',
    ...
    concentration: false,
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    description: 'Teletransporte inmediato a corta distancia.'
  },
  {
    id: 'divination',
    name: 'Adivinación',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Obtienes información de una entidad divina.'
  },
  {
    id: 'dominate_beast',
    name: 'Dominar Bestia',
    ...
    concentration: true,
    classes: ['druid', 'sorcerer', 'wizard'],
    description: 'Controlas una bestia.'
  },
  {
    id: 'fabricate',
    name: 'Fabricar',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Transforma materiales en objetos.'
  },
  {
    id: 'fire_shield',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Daño a atacantes + resistencia al frío o fuego.'
  },
  {
    ...
    description: 'Ignora efectos que restrinjan movimiento.'
  },
  {
    id: 'giant_insect',
    ...
    concentration: true,
    classes: ['druid'],
    description: 'Convierte insectos en versiones gigantes.'
  },
  {
    ...
    concentration: true,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Invisibilidad que no se rompe al atacar.'
  },
  {
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Entidad que daña enemigos cercanos.'
  },
  {
    ...
    description: 'Cambia apariencia del terreno.'
  },
  {
    id: 'ice_storm',
    ...
    concentration: false,
    classes: ['druid', 'sorcerer', 'wizard'],
    description: 'Daño en área + terreno difícil.'
  },
  {
    id: 'locate_creature',
    ...
    concentration: true,
    classes: ['bard', 'cleric', 'druid', 'paladin', 'ranger', 'wizard'],
    description: 'Detecta ubicación de una criatura.'
  },
  {
    id: 'polymorph',
    name: 'Polimorfia',
    ...
    concentration: true,
    classes: ['bard', 'druid', 'sorcerer', 'wizard'],
    description: 'Transforma una criatura en otra forma.'
  },
  {
    id: 'stone_shape',
    name: 'Moldear Piedra',
    ...
    concentration: false,
    classes: ['cleric', 'druid', 'wizard'],
    description: 'Moldea piedra en formas útiles.'
  },
  {
    id: 'stoneskin',
    name: 'Piel de Piedra',
    ...
    concentration: true,
    classes: ['druid', 'ranger', 'sorcerer', 'wizard'],
    description: 'Resistencia a daño físico.'
  },
  {
    id: 'wall_of_fire',
    name: 'Muro de Fuego',
    ...
    concentration: true,
    classes: ['druid', 'sorcerer', 'wizard'],
    description: 'Crea un muro que daña enemigos.'
  }
];
...
export const SPELLS_LEVEL_5: SpellDefinition[] = [
  {
    ...
    concentration: true,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Objetos cobran vida y atacan bajo tu control.'
  },
  {
    id: 'awaken',
    name: 'Despertar',
    ...
    concentration: false,
    classes: ['bard', 'druid'],
    description: 'Otorga inteligencia y conciencia a bestias o plantas.'
  },
  {
    id: 'banishing_smite',
    ...
    concentration: true,
    classes: ['paladin'],
    description: 'Ataque que puede desterrar al objetivo.'
  },
  {
    id: 'circle_of_power',
    ...
    concentration: true,
    classes: ['paladin'],
    description: 'Otorga ventaja contra magia y reduce daño mágico.'
  },
  {
    id: 'cloudkill',
    name: 'Nube Mortal',
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Nube venenosa que daña criaturas cada turno.'
  },
  {
    id: 'commune',
    name: 'Comunión',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Consultas a una deidad con preguntas limitadas.'
  },
  {
    ...
    concentration: false,
    classes: ['druid', 'ranger'],
    description: 'Obtienes información del entorno natural.'
  },
  {
    id: 'cone_of_cold',
    name: 'Cono de Frío',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Gran daño de frío en área.'
  },
  {
    ...
    concentration: true,
    classes: ['druid', 'wizard'],
    description: 'Invoca un elemental poderoso.'
  },
  {
    id: 'conjure_volley',
    name: 'Descarga Conjurada',
    level: 5,
    school: 'Conjuración',
    castingTime: '1 acción',
    range: '150 pies',
    ...
    concentration: false,
    classes: ['ranger'],
    description: 'Ataque en área con proyectiles mágicos.'
  },
  {
    ...
    concentration: false,
    classes: ['warlock', 'wizard'],
    description: 'Obtienes conocimiento de entidades extraplanares.'
  },
  {
    id: 'contagion',
    name: 'Contagio',
    ...
    concentration: false,
    classes: ['cleric', 'druid', 'wizard'],
    description: 'Infecta al objetivo con una enfermedad debilitante.'
  },
  {
    id: 'creation',
    name: 'Creación',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Creas un objeto a partir de sombra.'
  },
  {
    id: 'destructive_wave',
    name: 'Ola Destructiva',
    level: 5,
    school: 'Evocación',
    castingTime: '1 acción',
    range: 'Personal (30 pies)',
    ...
    concentration: false,
    classes: ['paladin'],
    description: 'Daño masivo y derribo en área.'
  },
  {
    ...
    concentration: true,
    classes: ['cleric', 'paladin'],
    description: 'Protección contra criaturas extraplanares.'
  },
  {
    id: 'dominate_person',
    ...
    concentration: true,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Control total sobre un humanoide.'
  },
  {
    id: 'dream',
    name: 'Sueño',
    ...
    concentration: false,
    classes: ['bard', 'warlock', 'wizard'],
    description: 'Envías mensajes o pesadillas a través de sueños.'
  },
  {
    id: 'flame_strike',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Columna de fuego radiante y fuego.'
  },
  {
    id: 'geas',
    name: 'Geas',
    ...
    description: 'Impone una orden mágica a largo plazo.'
  },
  {
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'druid', 'ranger'],
    description: 'Elimina efectos debilitantes graves.'
  },
  {
    id: 'hallow',
    name: 'Santificar',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Consagra un área con efectos protectores.'
  },
  {
    id: 'hold_monster',
    ...
    concentration: true,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Paraliza a cualquier criatura.'
  },
  {
    id: 'insect_plague',
    ...
    description: 'Enjambre que daña y dificulta visión.'
  },
  {
    id: 'legend_lore',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'wizard'],
    description: 'Obtienes información histórica o mágica.'
  },
  {
    id: 'mass_cure_wounds',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'druid'],
    description: 'Cura múltiples aliados en área.'
  },
  {
    id: 'mislead',
    name: 'Engaño',
    ...
    concentration: true,
    classes: ['bard', 'wizard'],
    description: 'Te vuelves invisible y creas un duplicado ilusorio.'
  },
  {
    id: 'modify_memory',
    ...
    concentration: true,
    classes: ['bard', 'wizard'],
    description: 'Alteras recuerdos de una criatura.'
  },
  {
    id: 'planar_binding',
    name: 'Vínculo Planar',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'druid', 'sorcerer', 'warlock', 'wizard'],
    description: 'Atas una criatura extraplanar a tu servicio.'
  },
  {
    id: 'raise_dead',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'paladin'],
    description: 'Devuelve a la vida a una criatura fallecida.'
  },
  {
    id: 'rarys_telepathic_bond',
    name: 'Vínculo Telepático de Rary',
    level: 5,
    school: 'Adivinación',
    castingTime: '1 acción',
    range: '30 pies',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Comunicación telepática en grupo.'
  },
  {
    id: 'reincarnate',
    name: 'Reencarnar',
    ...
    concentration: false,
    classes: ['druid'],
    description: 'Revive a una criatura en un nuevo cuerpo.'
  },
  {
    id: 'scrying',
    name: 'Adivinación Remota',
    level: 5,
    school: 'Adivinación',
    castingTime: '10 minutos',
    range: 'Personal',
    ...
    description: 'Observas a una criatura a distancia.'
  },
  {
    id: 'seeming',
    name: 'Apariencia',
    ...
    concentration: false,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Cambia la apariencia de múltiples criaturas.'
  },
  {
    id: 'telekinesis',
    name: 'Telequinesis',
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Mueve criaturas u objetos con la mente.'
  },
  {
    ...
    concentration: false,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Portal a un círculo conocido.'
  },
  {
    id: 'tree_stride',
    name: 'Paso Arbóreo',
    ...
    concentration: true,
    classes: ['druid', 'ranger'],
    description: 'Te mueves entre árboles instantáneamente.'
  },
  {
    id: 'wall_of_force',
    name: 'Muro de Fuerza',
    ...
    concentration: true,
    classes: ['wizard'],
    description: 'Barrera invisible casi indestructible.'
  },
  {
    id: 'wall_of_stone',
    name: 'Muro de Piedra',
    ...
    concentration: true,
    classes: ['wizard'],
    description: 'Crea una pared sólida de piedra.'
  }
];
...
export const SPELLS_LEVEL_6: SpellDefinition[] = [
  {
    ...
    concentration: true,
    classes: ['sorcerer', 'warlock', 'wizard'],
    description: 'Crea dos portales conectados para atravesar instantáneamente.'
  },
  {
    id: 'blade_barrier',
    ...
    concentration: true,
    classes: ['cleric'],
    description: 'Muro de cuchillas que daña a quien lo atraviese.'
  },
  {
    id: 'chain_lightning',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Rayo que salta entre múltiples objetivos.'
  },
  {
    id: 'circle_of_death',
    ...
    concentration: false,
    classes: ['sorcerer', 'warlock', 'wizard'],
    description: 'Gran área de daño necrótico.'
  },
  {
    id: 'conjure_fey',
    ...
    description: 'Invoca una criatura feérica poderosa.'
  },
  {
    id: 'contingency',
    name: 'Contingencia',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Prepara un hechizo que se activa bajo una condición.'
  },
  {
    id: 'create_undead',
    ...
    concentration: false,
    classes: ['cleric', 'warlock', 'wizard'],
    description: 'Crea no-muertos más poderosos que Animate Dead.'
  },
  {
    id: 'disintegrate',
    name: 'Desintegrar',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Gran daño; puede convertir en polvo al objetivo.'
  },
  {
    id: 'druid_grove',
    name: 'Arboleda Druídica',
    level: 6,
    school: 'Abjuración',
    castingTime: '10 minutos',
    range: 'Toque',
    ...
    concentration: false,
    classes: ['druid'],
    description: 'Protege un área natural con múltiples efectos.'
  },
  {
    id: 'find_the_path',
    ...
    concentration: true,
    classes: ['bard', 'cleric', 'druid'],
    description: 'Revela la ruta más directa hacia un destino.'
  },
  {
    id: 'flesh_to_stone',
    name: 'Carne a Piedra',
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Petrifica gradualmente al objetivo.'
  },
  {
    id: 'forbiddance',
    name: 'Prohibición',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Protege un área contra criaturas y viajes planares.'
  },
  {
    ...
    school: 'Abjuración',
    castingTime: '1 acción',
    range: 'Personal (10 pies)',
    components: 'V, S, M',
    duration: 'Concentración, hasta 1 minuto',
    concentration: true,
    classes: ['wizard'],
    description: 'Bloquea hechizos de bajo nivel dentro del área.'
  },
  {
    id: 'harm',
    name: 'Herir',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Reduce fuertemente los puntos de vida del objetivo.'
  },
  {
    id: 'heal',
    name: 'Sanar',
    ...
    concentration: false,
    classes: ['cleric', 'druid'],
    description: 'Restaura gran cantidad de vida y elimina condiciones.'
  },
  {
    id: 'heroes_feast',
    name: 'Festín Heroico',
    ...
    concentration: false,
    classes: ['cleric', 'druid'],
    description: 'Otorga buffs importantes a varios aliados.'
  },
  {
    id: 'magic_jar',
    name: 'Recipiente Mágico',
    level: 6,
    school: 'Nigromancia',
    castingTime: '1 minuto',
    range: 'Personal',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Permite poseer otros cuerpos.'
  },
  {
    id: 'mass_suggestion',
    name: 'Sugerencia Masiva',
    level: 6,
    school: 'Encantamiento',
    castingTime: '1 acción',
    range: '60 pies',
    ...
    concentration: false,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Influye en múltiples criaturas con una orden razonable.'
  },
  {
    id: 'move_earth',
    name: 'Mover Tierra',
    ...
    concentration: true,
    classes: ['druid', 'wizard'],
    description: 'Reconfigura terreno de tierra o arena.'
  },
  {
    id: 'planar_ally',
    name: 'Aliado Planar',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Invoca una entidad extraplanar que puede ayudarte.'
  },
  {
    ...
    concentration: false,
    classes: ['bard', 'wizard'],
    description: 'Ilusión que se activa bajo condiciones específicas.'
  },
  {
    id: 'sunbeam',
    name: 'Rayo Solar',
    ...
    concentration: true,
    classes: ['druid', 'sorcerer', 'wizard'],
    description: 'Rayo radiante repetible que ciega enemigos.'
  },
  {
    id: 'true_seeing',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'sorcerer', 'warlock', 'wizard'],
    description: 'Permite ver invisibilidad y la verdadera forma de las cosas.'
  },
  {
    id: 'wall_of_ice',
    name: 'Muro de Hielo',
    ...
    concentration: true,
    classes: ['wizard'],
    description: 'Crea una barrera de hielo que puede dañar.'
  },
  {
    id: 'wind_walk',
    ...
    concentration: false,
    classes: ['cleric', 'druid'],
    description: 'Transforma al grupo en nubes veloces.'
  },
  {
    id: 'word_of_recall',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Teletransporta al grupo a un santuario previamente definido.'
  }
];
...
export const SPELLS_LEVEL_7: SpellDefinition[] = [
  {
    ...
    concentration: true,
    classes: ['cleric'],
    description: 'Invoca un celestial poderoso para que te ayude.'
  },
  {
    id: 'crown_of_stars',
    ...
    concentration: false,
    classes: ['sorcerer', 'warlock', 'wizard'],
    description: 'Orbes de energía que puedes disparar como ataques.'
  },
  {
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Explosión que aumenta su daño cuanto más se retrasa.'
  },
  {
    id: 'divine_word',
    name: 'Palabra Divina',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Efectos devastadores según los puntos de vida del enemigo.'
  },
  {
    id: 'etherealness',
    name: 'Etereidad',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'sorcerer', 'warlock', 'wizard'],
    description: 'Viajas al Plano Etéreo.'
  },
  {
    id: 'finger_of_death',
    ...
    concentration: false,
    classes: ['sorcerer', 'warlock', 'wizard'],
    description: 'Gran daño necrótico; puede crear un zombi.'
  },
  {
    id: 'fire_storm',
    ...
    concentration: false,
    classes: ['cleric', 'druid'],
    description: 'Columnas de fuego que dañan en múltiples áreas.'
  },
  {
    id: 'forcecage',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Encierra criaturas sin salvación inicial.'
  },
  {
    id: 'mirage_arcane',
    ...
    concentration: false,
    classes: ['bard', 'druid', 'wizard'],
    description: 'Transforma completamente el terreno en ilusión realista.'
  },
  {
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Crea una mansión extradimensional lujosa y segura.'
  },
  {
    ...
    concentration: true,
    classes: ['bard', 'wizard'],
    description: 'Espada flotante que ataca enemigos.'
  },
  {
    id: 'plane_shift',
    ...
    description: 'Transporta criaturas a otros planos.'
  },
  {
    id: 'prismatic_spray',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Efectos aleatorios de rayos de distintos colores.'
  },
  {
    id: 'project_image',
    ...
    concentration: true,
    classes: ['bard', 'wizard'],
    description: 'Creas una copia ilusoria a gran distancia.'
  },
  {
    id: 'regenerate',
    name: 'Regenerar',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'druid'],
    description: 'Regenera puntos de vida y miembros perdidos.'
  },
  {
    id: 'resurrection',
    name: 'Resurrección',
    ...
    concentration: false,
    classes: ['bard', 'cleric'],
    description: 'Devuelve a la vida a una criatura muerta hace tiempo.'
  },
  {
    id: 'reverse_gravity',
    ...
    concentration: true,
    classes: ['druid', 'sorcerer', 'wizard'],
    description: 'Invierte la gravedad en un área.'
  },
  {
    id: 'sequester',
    name: 'Secuestrar',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Oculta una criatura u objeto fuera del tiempo.'
  },
  {
    id: 'simulacrum',
    name: 'Simulacro',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Crea una copia parcial de una criatura.'
  },
  {
    id: 'symbol',
    name: 'Símbolo',
    ...
    concentration: false,
    classes: ['bard', 'cleric', 'wizard'],
    description: 'Glifo poderoso con efectos variados.'
  },
  {
    id: 'teleport',
    name: 'Teletransporte',
    ...
    concentration: false,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Teletransporta a gran distancia con precisión variable.'
  }
];
...
export const SPELLS_LEVEL_8: SpellDefinition[] = [
  {
    ...
    concentration: true,
    classes: ['cleric', 'wizard'],
    description: 'Anula magia dentro de un área alrededor del lanzador.'
  },
  {
    ...
    concentration: false,
    classes: ['druid', 'wizard'],
    description: 'Hace que criaturas eviten o se acerquen a un objetivo.'
  },
  {
    id: 'clone',
    name: 'Clon',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Crea un cuerpo de reemplazo en caso de muerte.'
  },
  {
    id: 'control_weather',
    ...
    concentration: true,
    classes: ['cleric', 'druid', 'wizard'],
    description: 'Altera condiciones climáticas a gran escala.'
  },
  {
    id: 'demiplane',
    name: 'Semiplano',
    ...
    concentration: false,
    classes: ['warlock', 'wizard'],
    description: 'Crea una puerta a un plano extradimensional.'
  },
  {
    id: 'dominate_monster',
    ...
    concentration: true,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Control total sobre cualquier criatura.'
  },
  {
    id: 'earthquake',
    name: 'Terremoto',
    ...
    concentration: true,
    classes: ['cleric', 'druid', 'sorcerer'],
    description: 'Provoca un gran terremoto que daña estructuras y criaturas.'
  },
  {
    id: 'feeblemind',
    ...
    concentration: false,
    classes: ['bard', 'druid', 'warlock', 'wizard'],
    description: 'Reduce inteligencia y carisma a niveles mínimos.'
  },
  {
    id: 'glibness',
    name: 'Elocuencia Sobrenatural',
    level: 8,
    school: 'Transmutación',
    castingTime: '1 acción',
    range: 'Personal',
    ...
    concentration: false,
    classes: ['bard'],
    description: 'Tus tiradas sociales se vuelven extremadamente efectivas.'
  },
  {
    id: 'holy_aura',
    name: 'Aura Sagrada',
    ...
    concentration: true,
    classes: ['cleric'],
    description: 'Gran buff defensivo para aliados.'
  },
  {
    id: 'incendiary_cloud',
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Nube de fuego que daña continuamente.'
  },
  {
    id: 'maze',
    name: 'Laberinto',
    ...
    concentration: true,
    classes: ['wizard'],
    description: 'Atrapa a una criatura en un laberinto extradimensional.'
  },
  {
    id: 'mind_blank',
    ...
    concentration: false,
    classes: ['bard', 'wizard'],
    description: 'Inmunidad a daño psíquico y detección mental.'
  },
  {
    id: 'power_word_stun',
    ...
    concentration: false,
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    description: 'Aturde automáticamente a objetivos con pocos HP.'
  },
  {
    id: 'sunburst',
    ...
    description: 'Gran daño radiante y ceguera en área.'
  },
  {
    id: 'telepathy',
    name: 'Telepatía',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Comunicación mental a cualquier distancia.'
  }
];
...
export const SPELLS_LEVEL_9: SpellDefinition[] = [
  {
    ...
    concentration: false,
    classes: ['cleric', 'warlock', 'wizard'],
    description: 'Viajas al Plano Astral con tu forma espiritual.'
  },
  {
    id: 'foresight',
    name: 'Presciencia',
    ...
    concentration: false,
    classes: ['bard', 'druid', 'warlock', 'wizard'],
    description: 'Ventaja en todo y desventaja para atacarte.'
  },
  {
    id: 'gate',
    name: 'Portal',
    ...
    description: 'Abre un portal entre planos o invoca criaturas.'
  },
  {
    id: 'imprisonment',
    ...
    concentration: false,
    classes: ['warlock', 'wizard'],
    description: 'Encierra a una criatura con efectos permanentes.'
  },
  {
    id: 'mass_heal',
    name: 'Sanación Masiva',
    level: 9,
    school: 'Evocación',
    castingTime: '1 acción',
    range: '60 pies',
    ...
    concentration: false,
    classes: ['cleric'],
    description: 'Restaura enormes cantidades de vida a múltiples aliados.'
  },
  {
    id: 'mass_polymorph',
    name: 'Polimorfia Masiva',
    level: 9,
    school: 'Transmutación',
    castingTime: '1 acción',
    range: '120 pies',
    ...
    concentration: true,
    classes: ['bard', 'sorcerer', 'wizard'],
    description: 'Transforma múltiples criaturas simultáneamente.'
  },
  {
    id: 'meteor_swarm',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Cuatro explosiones masivas con daño devastador.'
  },
  {
    id: 'power_word_heal',
    name: 'Palabra de Poder: Curar',
    level: 9,
    school: 'Evocación',
    castingTime: '1 acción',
    range: 'Toque',
    ...
    concentration: false,
    classes: ['bard'],
    description: 'Cura completamente y elimina múltiples condiciones.'
  },
  {
    id: 'power_word_kill',
    ...
    concentration: false,
    classes: ['sorcerer', 'warlock', 'wizard'],
    description: 'Mata instantáneamente a objetivos con HP bajo.'
  },
  {
    id: 'prismatic_wall',
    ...
    concentration: false,
    classes: ['wizard'],
    description: 'Muro con múltiples capas de efectos devastadores.'
  },
  {
    id: 'shapechange',
    ...
    concentration: true,
    classes: ['druid', 'wizard'],
    description: 'Te transformas en criaturas poderosas conservando habilidades.'
  },
  {
    id: 'time_stop',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'Actúas durante varios turnos sin que otros puedan reaccionar.'
  },
  {
    id: 'true_polymorph',
    ...
    concentration: true,
    classes: ['bard', 'warlock', 'wizard'],
    description: 'Transformación permanente en otra criatura u objeto.'
  },
  {
    ...
    concentration: false,
    classes: ['cleric', 'druid'],
    description: 'Devuelve a la vida incluso sin cuerpo.'
  },
  {
    id: 'weird',
    name: 'Pesadilla',
    ...
    concentration: true,
    classes: ['sorcerer', 'wizard'],
    description: 'Provoca miedo extremo y daño psíquico en área.'
  },
  {
    id: 'wish',
    name: 'Deseo',
    ...
    concentration: false,
    classes: ['sorcerer', 'wizard'],
    description: 'El hechizo más poderoso: puede replicar casi cualquier efecto.'
  }
];
